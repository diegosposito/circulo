...
<script>
  ...
  function deleteFile(parametro){
     $.post("<?php echo url_for('archivosprofesionales/deletefile'); ?>",
          {id: parametro},
        function(data){
...
<?php if($sf_user->getGuardUser()->getIsSuperAdmin()){ ?>
         ...
         <a href="<?php echo url_for('archivosprofesionales/new') ?>">Nuevo Archivo de Profesional</a>
  <?php } ?>

<br>
<div align="center">
 <a href="<?php echo url_for('archivosprofesionales/index') ?>"><img src='<?php echo $sf_request->getRelativeUrlRoot();?>/images/refresh.png' align='center' size='20' height='28' width="28" /></a>  
</div>
