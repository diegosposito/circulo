 ...
 */
class ActualizacionestratForm extends BaseActualizacionestratForm
{
  public function configure()
  {
	  ...
	  $this->widgetSchema->setLabel('nombre', '<p align="left">Detalle del Archivo:</p>');
